...
void manejarMensajes(int argc, char *argv[]) {
	...
	int socketCliente;
	log_info(logger, "Conectando a PUERTO=%d en IP=%s", gameBoyConf->ipBroker,
			gameBoyConf->puertoBroker);
...
//			socketCliente = crearConexion(gameBoyConf->ipBroker,
//					gameBoyConf->puertoBroker, 30);
//			enviarMensajeRecursoAppeared(argv[3], (int) argv[4], (int) argv[5],
//					(int) argv[6], socketCliente);
//
//		}
//
...
//			socketCliente = crearConexion(gameBoyConf->ipBroker,
//					gameBoyConf->puertoBroker, 30);
//			enviarMensajeRecursoCatch(argv[3], (int) argv[4], (int) argv[5],
//					socketCliente);
//
//		}
//
...
//			socketCliente = crearConexion(gameBoyConf->ipBroker,
//					gameBoyConf->puertoBroker, 30);
//			enviarMensajeRecursoCaught((int) argv[3], (int) argv[4],
//					socketCliente);	///falta el id mensaje
//		}
//
//	}
...
//			socketCliente = crearConexion(gameBoyConf->ipBroker,
//					gameBoyConf->puertoBroker, 30);
//			enviarMensajeRecursoGet(argv[3], socketCliente);
//
//		}
//		//break;
//	}
