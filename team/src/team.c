...
//	}
	...
	prueba1=malloc(sizeof(t_posicion)); prueba2=malloc(sizeof(t_posicion)); prueba3=malloc(sizeof(t_posicion));
	prueba1->x=3; prueba1->y=2; prueba2->x=2; prueba2->y=5; prueba3->x=5; prueba3->y=2;
